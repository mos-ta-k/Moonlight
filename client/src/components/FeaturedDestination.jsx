...
const FeaturedDestination = () => {
  ...
  // Fix #1: cleaner null check instead of inline && which can render "0" if rooms is empty
  ...
  return (
    <div className='flex flex-col items-center bg-slate-50 px-3 md:px-9 lg:px-12 py-15'>
      ...
      <div className='flex flex-wrap items-center justify-center px-6 md:px-16 lg:px-24 bg-slate-50 py-15 pb-5 gap-7'>
        {/* Fix #2: duplicate lg:px-16 lg:px-24 — removed duplicate */}
      ...
      <button
        ...
        // Fix #3: border-grey-300 is invalid Tailwind → border-gray-300
