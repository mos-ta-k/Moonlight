...
const SEARCH_DATA = [
    ...
    { title: 'Hotels', path: '/rooms', description: 'Browse all available rooms and hotels' },
    { title: 'Experience', path: '/', description: 'Explore curated experiences' },
    { title: 'About', path: '/', description: 'Learn more about us' },
    { title: 'My Bookings', path: '/my-bookings', description: 'View and manage your bookings' },
    { title: 'Owner Dashboard', path: '/owner', description: 'Manage your property listings' },
    { title: 'Deluxe Suite', path: '/rooms', description: 'Luxury suite with ocean view' },
    { title: 'Standard Room', path: '/rooms', description: 'Comfortable standard rooms' },
    { title: 'Family Room', path: '/rooms', description: 'Spacious rooms for families' },
    { title: 'Beach Resort', path: '/rooms', description: 'Rooms at beachside resorts' },
    { title: 'Mountain Retreat', path: '/rooms', description: 'Cozy mountain getaway rooms' },
    { title: 'City Hotel', path: '/rooms', description: 'Hotels in the city center' },
];
            ...
            >
                ...
                <input
                    ...
                    className={`bg-transparent outline-none text-sm w-full ${
                        isScrolled ? 'text-gray-800 placeholder-gray-400' : 'text-white placeholder-white/70'
                    }`}
                />
    ...
    return (
        ...
        >
            ...
            <div className="hidden md:flex items-center gap-4 lg:gap-8">
                ...
                <div
                    className={`transition-all duration-300 overflow-visible ${
                        isSearchOpen ? 'opacity-100 max-w-xs w-72' : 'opacity-0 max-w-0 w-0 pointer-events-none'
                    }`}
                >
                    {isSearchOpen && (
                        <SearchBar isScrolled={isScrolled} onClose={() => setIsSearchOpen(false)} />
                    )}
                </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:hidden">
                ...
                <button onClick={() => setIsSearchOpen(prev => !prev)} aria-label="Search" className="cursor-pointer">
                    <img
                        src={assets.searchIcon}
                        alt="search icon"
            ...
            <div
                className={`absolute top-full left-0 w-full px-4 md:hidden transition-all duration-300 ${
                    isSearchOpen ? 'opacity-100 translate-y-0 pointer-events-auto py-3 bg-white shadow-md' : 'opacity-0 -translate-y-2 pointer-events-none'
                }`}
            >
                {isSearchOpen && (
