  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            <h1 className='text-3xl md:text-4xl font-playfair'>{room.hotel.name} <span className='font-normal text-sm'>({room.roomType})</span></h1>
            <p className='text-xl font-medium text-gray-700 bg-green-100 px-3 py-1 rounded-full bg-orange-500 text-white rounded-full'>20% OFF</p>
        </div>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl font-playfair md:text-4xl'>Experinece Luxury Like Never Before</h1>
                <div className='flex flex-wrap items-center mt-3  mb-6 gap-4'>
                    {room.amenities.map((item,index)=>(
                        <div key={index} className='flex items-center gap-2 px-3 py-2 roundedlg bg-gray-100'>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center md:gap-10 text-gray-500 gap-4'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='checkInDate' placeholder='dd/mm/yyyy'  className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                </div>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='checkOutDate' placeholder='dd/mm/yyyy'  className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                </div>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guest will be allocated on the ground floor accordinng to availability. You get a comfortable two bedroom apartment has a true city feelings. The price qouted is for two guests, at the guest slot pleace mark the number of guests to get the exact price for the group. The guests will be allocated group floor accordinng to availability. You will get comfortable tow bedroom apartment that has a true city feelings.</p>
        </div>
