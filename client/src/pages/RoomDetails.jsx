...
const RoomDetails = () => {
  const { id } = useParams();
  const [{ room, mainImage }, setRoomData] = useState({
    room: null,
    mainImage: null,
  });
      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          <h1 className="text-3xl md:text-4xl font-playfair">
            {room.hotel.name}{" "}
            <span className="font-normal text-sm">({room.roomType})</span>
          </h1>
          <p className="text-xl font-medium px-3 py-1 rounded-full bg-orange-500 text-white">
            20% OFF
          </p>
        </div>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            city feelings. The price quoted is for two guests, at the guest slot
            please mark the number of guests to get the exact price for the
            group. The guests will be allocated ground floor according to
            availability. You will get comfortable two bedroom apartment that
            has a true city feelings.
          </p>
        </div>
        ...
        <div className="mt-20">
          ...
          <div
            className="relative w-full rounded-2xl overflow-hidden shadow-[0px_0px_20px_rgba(0,0,0,0.12)]"
            style={{ height: "420px" }}
          >
            <iframe
